...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ocupy " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"ocupy1.mooo.com", "ocupy1.mooo.com"},
    {"ocupy2.mooo.com", "ocupy2.mooo.com"},
    {"ocupy3.mooo.com", "ocupy3.mooo.com"},
    {"ocupy4.mooo.com", "ocupy4.mooo.com"},
    {"ocupy5.mooo.com", "ocupy5.mooo.com"},	
};
// hidden service seeds
static const char *strMainNetOnionSeed[][1] = {
    {"aicmsghfwjbenhtg.onion"}, //node04 (Native)
    {"7d7rsrnxldr6bdib.onion"}, //node05 (Hybrid)
    {"fd4z5n7bwzcedwer.onion"}, //node03 (Native)
    {"6pa6teg4qh5s3tcy.onion"}, //node02 (Native)
    {"6qfe6htdmfmyzhf4.onion"},
    {"k52sir4zxm7empr5.onion"},
    {"unb5hklqjqfwfpfz.onion"},
    {NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ocupy is probably already running."), addrBind.ToString().c_str());
        else
