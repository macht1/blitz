...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "blitz " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"blitz1.mooo.com", "blitz1.mooo.com"},
    {"blitz2.mooo.com", "blitz2.mooo.com"},
    {"blitz3.mooo.com", "blitz3.mooo.com"},
    {"blitz4.mooo.com", "blitz4.mooo.com"},
    {"blitz5.mooo.com", "blitz5.mooo.com"},	
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. blitz is probably already running."), addrBind.ToString().c_str());
        else
