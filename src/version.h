...
#ifndef BLITZ_VERSION_H
#define BLITZ_VERSION_H
...
static const int MIN_PEER_PROTO_VERSION = 238;

static const int INIT_PROTO_VERSION = 238;
...
static const int CANONICAL_BLOCK_SIG_LOW_S_VERSION = 75000;
