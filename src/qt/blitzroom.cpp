...
#include "blitzroom.h"
#include "ui_blitzroom.h"

BlitzRoom::BlitzRoom(QWidget *parent)
    : QWidget(parent), ui(new Ui::BlitzRoomClass)
{
    ui->setupUi(this);
...
void BlitzRoom::disconnectFromServer() {
...
void BlitzRoom::tabJoined()
{
    joining=true;
}
void BlitzRoom::tabJoining()
{
    joining=false;
...
void BlitzRoom::closeEvent(QCloseEvent *event)
{
    (void) event;
...
void BlitzRoom ::setModel(ClientModel *model)
{
    this->model = model;
}
