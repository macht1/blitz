...
#ifndef BLITZ_WALLET_H
#define BLITZ_WALLET_H
...
public:
    ...
    void AddSupportingTransactions(CDBWrapper& txdb);

    bool AcceptWalletTransaction(CDBWrapper& txdb);
    bool AcceptWalletTransaction();

    void RelayWalletTransaction(CDBWrapper& txdb);
